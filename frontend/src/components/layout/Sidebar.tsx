...
export function Sidebar() {
    ...
    return (
        <nav className="w-60 min-w-[240px] bg-white border-r border-slate-200 flex flex-col py-6 relative z-10 shadow-sm">
            <div className="px-5 pb-6 border-b border-slate-200 flex items-center gap-2.5">
                <div className="w-8 h-8 bg-[#6c63ff] rounded-lg flex items-center justify-center text-white shadow-sm">
                ...
                <div>
                    <div className="font-bold text-sm leading-tight text-slate-900">Voice Agent</div>
                    <div className="text-[10px] text-slate-500">Med Spa AI</div>
                </div>
            </div>

            <div className="py-4 flex-1 overflow-y-auto">
                <div className="px-4 pb-1 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Overview</div>
                ...
                <div className="px-4 pb-1 mt-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Configuration</div>
                ...
                <NavItem to="/phone-numbers" icon={<Phone className="w-4 h-4" />} label="Phone Numbers" active={isActive("/phone-numbers")} />

                <div className="px-4 pb-1 mt-3 text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Data</div>
            ...
            <div className="px-5 py-4 border-t border-slate-200 text-[11px] text-slate-500 flex items-center">
...
function NavItem({ to, icon, label, active }: { to: string, icon: React.ReactNode, label: string, active: boolean }) {
    return (
        ...
        ${active
                    ? "text-[#6c63ff] border-[#6c63ff] bg-[#6c63ff]/5 font-semibold"
